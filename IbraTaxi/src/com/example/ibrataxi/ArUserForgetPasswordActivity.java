...
public class ArUserForgetPasswordActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.ar_activity_user_forget_password);
		...
		// define the button
		Button send_btn = (Button) findViewById(R.id.ar_user_f_get_password_btn);

		// define the text fields ( email and password )
		email_txt = (EditText) findViewById(R.id.ar_user_f_email_txt);
		...
		send_btn.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				if (errors > 0) {
					// show error message
					Toast.makeText(ArUserForgetPasswordActivity.this,
	...
	class AttemptForgetPassword extends AsyncTask<String, Void, String> {
		...
		protected void onPreExecute() {
			...
			pDialog = new ProgressDialog(ArUserForgetPasswordActivity.this);
			pDialog.setMessage("„Õ«Ê·… «—Ã«⁄ ﬂ·„… «·„—Ê— «·Œ«’… »ﬂ ...");
		...
		protected void onPostExecute(String file_url) {
			...
			Toast.makeText(ArUserForgetPasswordActivity.this,
					"ﬂ·„… «·„—Ê— «·Œ«’… »ﬂ ⁄Ì  : " + returned_password,
					Toast.LENGTH_LONG).show();

			// start the login activity
			Intent ar_user_login = new Intent(ArUserForgetPasswordActivity.this,
