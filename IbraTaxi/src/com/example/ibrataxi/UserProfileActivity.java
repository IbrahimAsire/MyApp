...
public class UserProfileActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		password = (EditText) findViewById(R.id.user_p_password_txt);
		first_name = (EditText) findViewById(R.id.user_p_first_name_txt);
		last_name = (EditText) findViewById(R.id.user_p_last_name_txt);
		address = (EditText) findViewById(R.id.user_p_address_txt);
		mobile = (EditText) findViewById(R.id.user_p_mobile_txt);
		email_txt = (EditText) findViewById(R.id.user_p_email_txt);
		...
		update_btn = (Button) findViewById(R.id.user_p_update_btn);
	...
	class AttemptUpdate extends AsyncTask<String, String, String> {
		...
		protected void onPostExecute(String message) {
			...
			Toast.makeText(UserProfileActivity.this, message, Toast.LENGTH_LONG)
					.show();

			// go to the login activity
			Intent login = new Intent(UserProfileActivity.this,
