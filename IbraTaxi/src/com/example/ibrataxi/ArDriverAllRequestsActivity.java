...
public class ArDriverAllRequestsActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.ar_activity_driver_all_requests);
		...
		driver_main_menu_btn = (Button) findViewById(R.id.ar_driver_main_menu_btn);
		...
		driver_main_menu_btn.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				Intent ar_menu = new Intent(ArDriverAllRequestsActivity.this,
						ArDriverMenuActivity.class);
				startActivity(ar_menu);
			}
		});
	...
	class AttemptOrder extends AsyncTask<String, String, String> {
		...
		protected void onPreExecute() {
			super.onPreExecute();
			pDialog = new ProgressDialog(ArDriverAllRequestsActivity.this);
			pDialog.setMessage("«—Ã«⁄ ﬂ«›… «·ÿ·»«  «·Œ«’… »ﬂ...");
		...
		protected void onPostExecute(String file_url) {
			...
			// define order list
			driver_order_lst = (ListView) findViewById(R.id.ar_driver_orders_lst);

			// define array adapter
			ArrayAdapter<String> adapter = new ArrayAdapter<String>(
					ArDriverAllRequestsActivity.this,
