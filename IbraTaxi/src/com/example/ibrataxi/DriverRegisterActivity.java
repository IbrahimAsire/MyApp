...
public class DriverRegisterActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		fname_txt = (EditText) findViewById(R.id.driver_r_fname_txt);
		lname_txt = (EditText) findViewById(R.id.driver_r_lname_txt);
		email_txt = (EditText) findViewById(R.id.driver_r_email_txt);
		address_txt = (EditText) findViewById(R.id.driver_r_address_txt);
		password_txt = (EditText) findViewById(R.id.driver_r_password_txt);
		mobile_txt = (EditText) findViewById(R.id.driver_r_mobile_txt);

		register_btn = (Button) findViewById(R.id.driver_r_register_btn);
	...
	class AttemptRegister extends AsyncTask<String, String, String> {
		...
		protected void onPostExecute(String message) {
			...
			Toast.makeText(DriverRegisterActivity.this, message,
					Toast.LENGTH_LONG).show();

			// go to the login activity
			Intent driver_login = new Intent(DriverRegisterActivity.this,
