...
public class ArUserProfileActivity extends Activity {
	...
	// Progress Dialog
		...
		private static final String UPDATE_URL = "http://ibrataxi.comze.com/user_update_profile.php";
		...
		protected void onCreate(Bundle savedInstanceState) {
			...
			setContentView(R.layout.ar_activity_user_profile);
			...
			password = (EditText) findViewById(R.id.ar_user_p_password_txt);
			first_name = (EditText) findViewById(R.id.ar_user_p_first_name_txt);
			last_name = (EditText) findViewById(R.id.ar_user_p_last_name_txt);
			address = (EditText) findViewById(R.id.ar_user_p_address_txt);
			mobile = (EditText) findViewById(R.id.ar_user_p_mobile_txt);
			email_txt = (EditText) findViewById(R.id.ar_user_p_email_txt);
			...
			update_btn = (Button) findViewById(R.id.ar_user_p_update_btn);
			...
			update_btn.setOnClickListener(new View.OnClickListener() {
				...
				public void onClick(View arg0) {
					...
					if (first_name.getText().toString().length() == 0) {
						errors += 1;
						first_name.setError("«œŒ· «”„ ’ÕÌÕ");
					}

					// validate the last name
					else if (last_name.getText().toString().length() == 0) {
						errors += 1;
						last_name.setError("«œŒ· «”„ ’ÕÌÕ");
					}
					...
					// validate the password ( not less than six character )
						...
						errors += 1;
						password.setError("«œŒ· ﬂ·„… „—Ê— ’ÕÌÕ… „‰ 8 «·Ï 15 Õ—› ÊÌÃ» «‰  Õ ÊÌ ⁄·Ï ⁄œœ Ê«Õœ ⁄·Ï «·√ﬁ·");
					...
					// validate the mobile number
							...
							|| !Pattern.matches(MOBILE_REGEX, mobile.getText()
									.toString())) {
						errors += 1;
						mobile.setError("«œŒ· —ﬁ„ ÃÊ«· ’ÕÌÕ  (ex: 0501234567)");
					}
					...
					if (errors > 0) {
						// show error message
						Toast.makeText(ArUserProfileActivity.this,
								"ﬁ„ » ’ÕÌÕ «·√Œÿ«¡ √Ê·«", Toast.LENGTH_LONG).show();
		...
		class AttemptUpdate extends AsyncTask<String, String, String> {
			...
			protected void onPreExecute() {
				super.onPreExecute();
				pDialog = new ProgressDialog(ArUserProfileActivity.this);
				pDialog.setMessage("Ã«—Ì  ÕœÌÀ «·„⁄·Ê„« ...");
			...
			protected void onPostExecute(String message) {
				...
				Toast.makeText(ArUserProfileActivity.this, message,
						Toast.LENGTH_LONG).show();

				// go to the login activity
				Intent ar_login = new Intent(ArUserProfileActivity.this,
						ArUserLoginActivity.class);
				startActivity(ar_login);
