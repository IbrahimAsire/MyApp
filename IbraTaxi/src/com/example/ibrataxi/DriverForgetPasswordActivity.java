...
public class DriverForgetPasswordActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		// define the button
		Button send_btn = (Button) findViewById(R.id.driver_f_get_password_btn);

		// define the text fields ( email and password )
		email_txt = (EditText) findViewById(R.id.driver_f_email_txt);
		...
		send_btn.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				if (errors > 0) {
					// show error message
					Toast.makeText(DriverForgetPasswordActivity.this,
	...
	class AttemptForgetPassword extends AsyncTask<String, Void, String> {
		...
		protected void onPreExecute() {
			...
			pDialog = new ProgressDialog(DriverForgetPasswordActivity.this);
		...
		protected void onPostExecute(String file_url) {
			...
			Intent driver_login = new Intent(DriverForgetPasswordActivity.this,
