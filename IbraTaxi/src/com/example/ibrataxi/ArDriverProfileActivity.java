...
public class ArDriverProfileActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.ar_activity_driver_profile);
		...
		password = (EditText) findViewById(R.id.ar_driver_p_password_txt);
		first_name = (EditText) findViewById(R.id.ar_driver_p_first_name_txt);
		last_name = (EditText) findViewById(R.id.ar_driver_p_last_name_txt);
		address = (EditText) findViewById(R.id.ar_driver_p_address_txt);
		mobile = (EditText) findViewById(R.id.ar_driver_p_mobile_txt);
		email_txt = (EditText) findViewById(R.id.ar_driver_p_email_txt);
		...
		update_btn = (Button) findViewById(R.id.ar_driver_p_update_btn);
		...
		update_btn.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				if (errors > 0) {
					// show error message
					Toast.makeText(ArDriverProfileActivity.this,
	...
	class AttemptUpdate extends AsyncTask<String, String, String> {
		...
		protected void onPreExecute() {
			super.onPreExecute();
			pDialog = new ProgressDialog(ArDriverProfileActivity.this);
		...
		protected void onPostExecute(String message) {
			...
			Toast.makeText(ArDriverProfileActivity.this, message,
					Toast.LENGTH_LONG).show();

			// go to the login activity
			Intent ar_login = new Intent(ArDriverProfileActivity.this,
