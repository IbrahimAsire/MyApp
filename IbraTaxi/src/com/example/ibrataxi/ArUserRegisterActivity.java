...
public class ArUserRegisterActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.ar_activity_user_register);
		...
		fname_txt = (EditText) findViewById(R.id.ar_user_r_fname_txt);
		lname_txt = (EditText) findViewById(R.id.ar_user_r_lname_txt);
		email_txt = (EditText) findViewById(R.id.ar_user_r_email_txt);
		address_txt = (EditText) findViewById(R.id.ar_user_r_address_txt);
		password_txt = (EditText) findViewById(R.id.ar_user_r_password_txt);
		mobile_txt = (EditText) findViewById(R.id.ar_user_r_mobile_txt);

		register_btn = (Button) findViewById(R.id.ar_user_r_register_btn);
		...
		register_btn.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				// validate the password ( not less than six character )
					...
					errors += 1;
					password_txt
							.setError("«œŒ· ﬂ·„… „—Ê— ’ÕÌÕ… „‰ 8 «·Ï 15 Õ—› ÊÌÃ» «‰  Õ ÊÌ ⁄·Ï ⁄œœ Ê«Õœ ⁄·Ï «·√ﬁ·");
				}

				// validate the address
				else if (address_txt.getText().toString().length() == 0) {
					errors += 1;
					address_txt.setError("«œŒ· ⁄‰Ê«‰ ’ÕÌÕ");
				}
				...
				// validate the mobile number
					...
					errors += 1;
					mobile_txt
							.setError("«œŒ· —ﬁ„ ÃÊ«· ’ÕÌÕ (ex: 0501234567)");
				}
				...
				if (errors > 0) {
					// show error message
					Toast.makeText(ArUserRegisterActivity.this,
	...
	class AttemptRegister extends AsyncTask<String, String, String> {
		...
		protected void onPreExecute() {
			super.onPreExecute();
			pDialog = new ProgressDialog(ArUserRegisterActivity.this);
		...
		protected void onPostExecute(String message) {
			...
			Toast.makeText(ArUserRegisterActivity.this, message,
					Toast.LENGTH_LONG).show();

			// go to the login activity
			Intent ar_user_login = new Intent(ArUserRegisterActivity.this,
