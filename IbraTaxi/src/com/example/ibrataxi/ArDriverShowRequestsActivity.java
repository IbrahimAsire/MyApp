...
public class ArDriverShowRequestsActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.ar_activity_driver_show_requests);
		...
		driver_main_menu_btn.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View arg0) {
				Intent ar_driver_menu = new Intent(
						ArDriverShowRequestsActivity.this,
	...
	class AttemptGetRequests extends AsyncTask<String, String, String> {
		...
		protected void onPreExecute() {
			super.onPreExecute();
			pDialog = new ProgressDialog(ArDriverShowRequestsActivity.this);
			pDialog.setMessage("«—Ã«⁄ Ã„Ì⁄ «·ÿ·»«  «·Œ«’… »ﬂ...");
