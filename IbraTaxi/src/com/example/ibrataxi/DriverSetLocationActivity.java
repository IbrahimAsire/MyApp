...
public class DriverSetLocationActivity extends FragmentActivity implements
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_driver_set_location);

		// set the current location text view
		currentlocation = (TextView) findViewById(R.id.current_location);

		driver_change_location_btn = (Button) findViewById(R.id.driver_change_location_btn);
	...
	public void onMarkerDragEnd(Marker arg0) {
		...
		// Setting latitude and longitude in the TextView tv_location
		currentlocation.setText("Latitude:" + dragLat + "\n Longitude:"
				+ dragLong);
		...
		Toast.makeText(getApplicationContext(), "Location Has been changed..!",
	...
	class AttemptChange extends AsyncTask<String, String, String> {
		...
		protected void onPreExecute() {
			super.onPreExecute();
			pDialog = new ProgressDialog(DriverSetLocationActivity.this);
			pDialog.setMessage("Attempting Updating Location Information...");
		...
		protected void onPostExecute(String message) {
			...
			Toast.makeText(DriverSetLocationActivity.this, message,
					Toast.LENGTH_LONG).show();

			// go to the login activity
			Intent driver_menu = new Intent(DriverSetLocationActivity.this,
