...
public class DriverChangeStatusActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_driver_change_status);
		
		driver_current_status_txt = (TextView) findViewById(R.id.driver_current_status_txt);
		
		// set the spinner to the activity
		driver_status_spinner = (Spinner) findViewById(R.id.driver_status_spinner);
		...
		ArrayAdapter<String> adapter = new ArrayAdapter<String>(
				DriverChangeStatusActivity.this,
		...
		driver_change_btn = (Button) findViewById(R.id.driver_change_btn);
	...
	class AttemptGetStatus extends AsyncTask<String, String, String> {
		...
		protected void onPreExecute() {
			super.onPreExecute();
			pDialog = new ProgressDialog(DriverChangeStatusActivity.this);
			pDialog.setMessage("Attempting Getting the current Status ...");
		...
		protected void onPostExecute(String message) {
			...
			Toast.makeText(DriverChangeStatusActivity.this, message,
	...
	class AttemptUpdate extends AsyncTask<String, String, String> {
		...
		protected void onPreExecute() {
			super.onPreExecute();
			pDialog = new ProgressDialog(DriverChangeStatusActivity.this);
			pDialog.setMessage("Attempting Updating Status Information...");
			pDialog.setIndeterminate(false);
			pDialog.setCancelable(false);
			pDialog.show();
		}
		...
		protected void onPostExecute(String message) {
			...
			Intent driver_menu = new Intent(DriverChangeStatusActivity.this,
