...
public class UserRequestTaxiActivity extends FragmentActivity implements
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_user_request_taxi);
		...
		driver_request_name = (TextView) findViewById(R.id.driver_request_name);
		driver_request_mobile = (TextView) findViewById(R.id.driver_request_mobile);
		driver_request_status = (TextView) findViewById(R.id.driver_request_status);
		driver_request_email = (TextView) findViewById(R.id.driver_request_email);

		user_make_request_btn = (Button) findViewById(R.id.user_make_request_btn);
		...
		user_make_request_btn.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				if (driver_request_status.getText().toString() != "Busy") {
					...
					Toast.makeText(UserRequestTaxiActivity.this,
							"Please check the driver status", Toast.LENGTH_LONG)
							.show();
				}
			}
		});
	...
	class LoadAllTaxiLocations extends AsyncTask<String, String, String> {
		...
		protected void onPreExecute() {
			super.onPreExecute();
			pDialog = new ProgressDialog(UserRequestTaxiActivity.this);
			pDialog.setMessage("Loading All Taxi Locations. Please wait...");
	...
	class AttempMakeRequest extends AsyncTask<String, String, String> {
		...
		protected void onPreExecute() {
			super.onPreExecute();
			pDialog = new ProgressDialog(UserRequestTaxiActivity.this);
			pDialog.setMessage("Saving your request . Please wait...");
			pDialog.setIndeterminate(false);
			pDialog.setCancelable(false);
			pDialog.show();
		}
		...
		protected void onPostExecute(String message) {
			...
			Toast.makeText(UserRequestTaxiActivity.this, message,
	...
	class AttemptDriverInfo extends AsyncTask<String, Void, String> {
		...
		protected void onPreExecute() {
			super.onPreExecute();
			pDialog = new ProgressDialog(UserRequestTaxiActivity.this);
			pDialog.setMessage("Getting Driver Information ...");
			pDialog.setIndeterminate(false);
			pDialog.setCancelable(false);
			pDialog.show();
		}
